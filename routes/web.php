...
Route::get('/loginweb','cUser@login');
...
Route::get('/admin/data_sewa', 'cSewa@cekStatus');
...
Route::get('/customer', 'cBarang@cekStatus');
...
// Auth::routes();
// Route::group(['prefix' => '/customer', 'middleware' => 'isLogin'], function(){
    // Route::post('/sewa/tambah','cSewa@addTransaksiPost');
// });
