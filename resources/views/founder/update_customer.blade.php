	...
	<div class="container">
		<section>
			...
			<form action="/founder/user_updating/{{ $user->id_user }}" method="post" style="margin-top: 30px">
				...
				<input name="update_customer" type="submit" class="btn btn-success btn-sm" value="Simpan" style="float: right;" />
				<button class="btn btn-primary btn-sm"><a href="/founder/list/customer" style="color: white">Kembali</a></button>
			</form>
