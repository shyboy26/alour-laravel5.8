                        ...
                        <table width="1000px" style="margin-top: 20px;margin-left: 5%">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name="username" class="textInput" value="{{ $transaksi->user->name }}" style="padding:7px; width: 127px;height:40px;margin-left:10px;margin-bottom: 12px" readonly>
                                </td>
                            </tr>
                            <tr>
                                <td>Nama Barang</td>
