				...
				<div class="modal-dialog">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
                            ...
                            -->
                            <button class="btn btn-success btn-sm"><a href='' style="color:white">Batal</a></button>
                            <button class="btn btn-success btn-sm"><a href='' style="color:white">Hapus</a></button>
						</div>
					</div>
				</div>
			</div>
